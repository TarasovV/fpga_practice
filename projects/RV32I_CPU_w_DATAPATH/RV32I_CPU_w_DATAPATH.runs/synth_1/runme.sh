...
HD_PWD='C:/projs/projects/RV32I_CPU_w_DATAPATH/RV32I_CPU_w_DATAPATH.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log computing_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source computing_unit.tcl
