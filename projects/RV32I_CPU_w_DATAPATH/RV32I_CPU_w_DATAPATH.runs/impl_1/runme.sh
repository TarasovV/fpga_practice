...
HD_PWD='C:/projs/projects/RV32I_CPU_w_DATAPATH/RV32I_CPU_w_DATAPATH.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log computing_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source computing_unit.tcl -notrace
